from odoo.tools import float_round, float_repr, get_lang, NON_BREAKING_SPACE
...
def floatRound(value, digits=2, rounding_method='HALF-EVEN', rounding_unit='decimals'):
    ...
    return float_repr(float_round(value, precision_digits=digits, rounding_method=rounding_method), digits)
