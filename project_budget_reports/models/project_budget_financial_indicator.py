...
(
    SELECT
        ...
        CASE
            WHEN p.total_amount_of_revenue != 0 THEN ROUND((p.total_amount_of_revenue - p.cost_price) / p.total_amount_of_revenue, 2)
            ELSE 0
    ...
    SELECT
        ...
        CASE
            WHEN ps.total_amount_of_revenue != 0 THEN ROUND((ps.total_amount_of_revenue - ps.cost_price) / ps.total_amount_of_revenue, 2)
            ELSE 0
        END AS profitability,
        0 AS distribution,
        'contracting' AS type,
