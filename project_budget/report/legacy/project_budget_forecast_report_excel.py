                ...
                for stage in stages:
                    ...
                    for spec in cur_budget_projects:
                        if spec.id in dict_formula['printed_projects']:
                            continue
                        if not ((spec.project_office_id == project_office or (spec.signer_id.different_project_offices_in_steps and spec.project_have_steps)) and spec.key_account_manager_id == project_manager):
                            continue
                        ...
                        if spec.vgo == '-':
                            ...
                            if spec.project_have_steps:
                                for step in spec.project_steps_ids:
                                    ...
                                    if ((spec.signer_id.different_project_offices_in_steps and step.project_office_id == project_office)
                                            or ((not spec.signer_id.different_project_offices_in_steps or not step.project_office_id) and spec.project_office_id == project_office)):
                                        ...
                                        if step.stage_id == stage:
                                            ...
                                            column = 0
                                            if spec.signer_id.different_project_offices_in_steps and step.project_office_id:
