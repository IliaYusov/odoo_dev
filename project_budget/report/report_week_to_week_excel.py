...
class report_week_to_week_excel(models.AbstractModel):
...
# end Поступление денежных средсв, с НДС
    ...
    def printworksheet(self, workbook, budget, namesheet, multipliers):
        ...
        projects = self.env['project_budget.financial_data_report'].search([])
    ...
    def generate_xlsx_report(self, workbook, data, budgets):
        ...
        self.printworksheet(workbook, budget, 'week to week', multipliers)
